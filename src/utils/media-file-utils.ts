...
export interface MediaFile {
    ...
    /** The local filename where the file is stored */
    fileKey: string;
    ...
    /** Local URL for accessing the file */
    url: string;
    ...
    /** URL to a thumbnail version (generated locally) */
    thumbnailUrl?: string;
...
export const MediaFileUtils = {
    ...
    async create(data: {
        ...
        resourceType?: string; // Resource type (image, video, raw)
    }): Promise<MediaFile> {
     ...
     * 
     * Note: This only deletes the database record, not the actual file from local storage.
     * The API route should handle deleting the file from local storage before calling this.
     * 
