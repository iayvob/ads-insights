      ...
      >
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center">
              <Badge variant="destructive" className="text-lg px-4 py-2 bg-gradient-to-r from-red-500 to-orange-500">
                Application Error
              </Badge>
            </div>
        ...
        >
          <p>
            ...
            <button 
              onClick={() => window.location.href = "mailto:support@adinsights.com?subject=Application Error&body=" + encodeURIComponent(`Error: ${error.message}\nTime: ${new Date().toISOString()}\nPage: ${window.location.href}`)}
