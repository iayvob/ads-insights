  ...
  const features = [
    {
      ...
      description: "Post to Facebook, Instagram, Twitter, and LinkedIn simultaneously"
    },
    {
      icon: Calendar,
      ...
      <div className="absolute inset-0 filter blur-sm">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-400">Social Media Publisher</h1>
            <p className="text-gray-400 text-lg mt-2">Create and schedule engaging content</p>
          </div>
            ...
            <CardContent className="p-8 text-center">
              ...
              >
                ...
                <p className="text-gray-600 text-lg">
                  Upgrade your account to unlock powerful social media publishing tools
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <span className="text-2xl font-bold text-gray-900">$19.99/mo</span>
                </div>
              ...
              >
                <p className="text-xs text-gray-500">
                  🎉 <strong>7-day free trial</strong> included with all premium plans
                </p>
              </motion.div>
            </CardContent>
          </Card>
