  ...
  const renderPostsAnalytics = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-pink-50 p-4 rounded-lg">
        <h3 className="font-semibold text-pink-800">Total Videos</h3>
        <p className="text-2xl font-bold text-pink-600">
          {formatNumber(data.posts?.totalPosts || 0)}
        </p>
      </div>
      <div className="bg-cyan-50 p-4 rounded-lg">
        <h3 className="font-semibold text-cyan-800">Avg Views</h3>
        <p className="text-2xl font-bold text-cyan-600">
          {formatNumber(data.posts?.avgImpressions || 0)}
        </p>
      </div>
      <div className="bg-purple-50 p-4 rounded-lg">
        <h3 className="font-semibold text-purple-800">Avg Engagement</h3>
        <p className="text-2xl font-bold text-purple-600">
          {formatNumber(data.posts?.avgEngagement || 0)}
        </p>
      </div>
      <div className="bg-orange-50 p-4 rounded-lg">
        <h3 className="font-semibold text-orange-800">Avg Reach</h3>
