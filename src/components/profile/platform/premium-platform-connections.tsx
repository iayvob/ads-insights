...
export function PremiumPlatformConnection({
  connectedPlatforms,
  loading,
  progress,
  isPremium,
    ...
    <div className="space-y-6">
      ...
      >
        {platformConfigs.map((platform) => {
          ...
          const expiringSoon =
            connectionData && isExpiringSoon(connectionData.expiresAt);
              ...
              >
                ...
                {!hasAccess && (
                  <div className="absolute top-3 left-3 z-10">
                    <Badge
                      variant="outline"
                      className="bg-white/90 text-gray-600 border-gray-300"
                    >
                      ...
                      >
                        ...
                        <div className="space-y-1 text-sm text-green-700">
                          ...
                          {connectionData.expiresAt && (
                            <p>
                              Expires: {formatDate(connectionData.expiresAt)}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      {!hasAccess ? (
                        <Alert className="border-orange-200 bg-orange-50">
                          ...
                          <AlertDescription className="text-orange-800">
                            <strong>
                              {getRestrictionMessage('platform', platform.name)}
                            </strong>
                          </AlertDescription>
                        </Alert>
                      ) : requiresPremium ? (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {connectedPlatforms.length} of {platformConfigs.length}{' '}
                  platforms connected
                </p>
              </div>
            </div>
            <div className="text-right">
              ...
              >
                {Math.round(
                  (connectedPlatforms.length / platformConfigs.length) * 100
                )}
                %
              </div>
